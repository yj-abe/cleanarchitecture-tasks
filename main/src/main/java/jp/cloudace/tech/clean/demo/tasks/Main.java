...
import jp.cloudace.tech.clean.demo.tasks.application.usecases.impl.CompleteTaskUseCase;
import jp.cloudace.tech.clean.demo.tasks.application.usecases.impl.CreateTaskUseCase;
import jp.cloudace.tech.clean.demo.tasks.application.usecases.impl.ListCompletedTaskUseCase;
import jp.cloudace.tech.clean.demo.tasks.application.usecases.impl.ListTasksUseCase;
...
import jp.cloudace.tech.clean.demo.tasks.infrastructure.task.repositories.TaskMemoryRepository;
import jp.cloudace.tech.clean.demo.tasks.presentation.controllers.CommandLineController;
import jp.cloudace.tech.clean.demo.tasks.presentation.presenters.PrintPresenter;
import jp.cloudace.tech.clean.demo.tasks.presentation.presenters.views.PrintView;
import jp.cloudace.tech.clean.demo.tasks.presentation.views.CommandLineView;
